...
public class Vehicle implements Comparable<Vehicle>
{
	...
	@Override
	public int compareTo(Vehicle anotherVehicle) //int com.app.core.Vehicle.compareTo(Vehicle anotherVehicle)
	{
		System.out.println("in vehicle : compare to");
		//sorting criteria : chasis no : String --Comparable<String>
		//i.e has implemented compareTo : <0 , =0 , > 0 : as unicode code values!
		return this.chasisNo.compareTo(anotherVehicle.chasisNo); //	int java.lang.String.compareTo(String anotherString)
	}
