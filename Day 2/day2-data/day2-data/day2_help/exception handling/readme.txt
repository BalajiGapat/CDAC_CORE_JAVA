...
Mandatory--- only in case of un handled(no try-catch) checked exceptions(i.e classes not extended from RuntimeException).
...
Method
public void close() throws Exception-- closes resources.
