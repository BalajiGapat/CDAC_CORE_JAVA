		...
		try (Scanner sc = new Scanner(System.in)) 
		{
			...
			while (!exit) 
			{
				System.out.println("Options 1. Create A/C 2. Display all accounts 3. Transfer Funds "
						+ "4.Close A/c 5. Fetch A/c Summary " + "6.Display names by acct type 7.Freeze A/cs 0.Exit");
				...
				try 
				{
					...
					case 2:// display acct details (admin)
						...
						acctMap.forEach((k,v)->System.out.println(v)); //by lambda expiration
						acctMap.values().forEach(System.out::println); //by method reference
						break;
